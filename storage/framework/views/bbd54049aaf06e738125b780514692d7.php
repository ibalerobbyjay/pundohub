...
<div class="container mt-5">
    ...
    <div class="card shadow-lg rounded-4 mb-4 bg-dark text-light" 
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <p><strong class="text-info">Case Title:</strong> <?php echo e($case->title); ?></p>
                    <p><strong class="text-info">Member:</strong> <?php echo e($case->user->name); ?></p>
                    <p><strong class="text-info">Date of Death:</strong> <?php echo e($case->date_of_death->format('F d, Y')); ?></p>
                    <p><strong class="text-info">Case Created:</strong> <?php echo e($case->created_at->format('F d, Y g:i A')); ?></p>
                </div>
                <div class="col-md-6">
                    <p><strong class="text-info">Name of Deceased:</strong> <?php echo e($case->description_name ?? 'N/A'); ?></p>
                    <p><strong class="text-info">Service Type:</strong> <?php echo e($case->description_what ?? 'N/A'); ?></p>
                    ...
                    <p><strong class="text-info">Location:</strong> <?php echo e($case->description_where ?? 'N/A'); ?></p>
                </div>
            </div>
            ...
            <?php if($case->description_notes): ?>
                <div class="mt-3 pt-3 border-top border-secondary">
                    ...
                    <p class="mb-0 text-light"><?php echo e($case->description_notes); ?></p>
                </div>
            <?php endif; ?>
        </div>
    </div>
        ...
        <div class="card-body">
            ...
            <?php if($case->remarks): ?>
                <div class="mb-4 p-3 bg-dark border border-secondary rounded-3">
                    ...
                    <p class="mb-0 text-light"><?php echo e($case->remarks); ?></p>
                    <small class="text-muted">Last updated: <?php echo e($case->updated_at->diffForHumans()); ?></small>
                </div>
            <?php else: ?>
                <div class="mb-4 p-3 bg-dark border border-secondary rounded-3">
            ...
            <form action="<?php echo e(route('bereavement-cases.updateRemarks', $case->id)); ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="remarks" id="remarks" class="form-control bg-dark text-light border-secondary" 
                              rows="4" placeholder="Add any remarks or updates about this case..."><?php echo e(old('remarks', $case->remarks)); ?></textarea>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center mt-4">
                    <div>
                        ...
                        <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-outline-light rounded-pill px-4 ms-2">
