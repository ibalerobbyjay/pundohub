...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('bereavement-cases.create')); ?>" class="btn btn-info text-white fw-bold rounded-3 px-4">
    ...
    <?php if($cases->isEmpty()): ?>
        <div class="card border-0 shadow-sm rounded-4 bg-light">
            <div class="card-body text-center py-5">
                ...
                <a href="<?php echo e(route('bereavement-cases.create')); ?>" class="btn btn-info text-white rounded-3 px-4">
                                ...
                                <tr class="border-top">
                                    <td class="ps-4">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fw-semibold text-dark mb-0"><?php echo e($case->title); ?></h6>
                                                <small class="text-muted">Case #<?php echo e($case->id); ?></small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="fw-medium text-dark"><?php echo e($case->user->name ?? 'N/A'); ?></span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="text-dark"><?php echo e($case->date_of_death->format('F d, Y')); ?></span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="<?php echo e(route('bereavement-cases.show', $case->id)); ?>" 
