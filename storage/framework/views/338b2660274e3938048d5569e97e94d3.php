    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="text-end">
            <div class="badge bg-light text-dark border px-3 py-2">
                ...
                Total Reports: <?php echo e($reports->count()); ?>
            ...
            <div class="col-md-4">
                <div class="card border-0 bg-light rounded-4">
                    <div class="card-body text-center">
                        ...
                        <h4 class="fw-bold text-dark"><?php echo e($reports->where('is_verified', true)->count()); ?></h4>
            ...
            <div class="col-md-4">
                <div class="card border-0 bg-light rounded-4">
                    <div class="card-body text-center">
                        ...
                        <h4 class="fw-bold text-dark"><?php echo e($reports->where('is_verified', false)->count()); ?></h4>
            ...
            <div class="col-md-4">
                <div class="card border-0 bg-light rounded-4">
                    <div class="card-body text-center">
                        ...
                        <h4 class="fw-bold text-dark"><?php echo e($reports->count()); ?></h4>
                                ...
                                <tr class="border-top">
                                    <td class="ps-4">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fw-semibold text-dark mb-0"><?php echo e($report->name_of_deceased); ?></h6>
                                                <small class="text-muted">Report #<?php echo e($report->id); ?></small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="text-dark"><?php echo e(\Carbon\Carbon::parse($report->date_of_death)->format('M d, Y')); ?></span>
                                        </div>
                                    </td>
                                    <td>
                                        <?php if($report->notes): ?>
                                            <div class="text-dark">
                                                <?php echo e(Str::limit($report->notes, 50)); ?>

                                                <?php if(strlen($report->notes) > 50): ?>
                                                    <span class="text-muted small" data-bs-toggle="tooltip" data-bs-title="<?php echo e($report->notes); ?>">
