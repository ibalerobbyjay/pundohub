        ...
        <div class="col-md-3 mb-3">
            <div class="card border-0 bg-light shadow-sm rounded-4">
                <div class="card-body text-center py-4">
                    ...
                    <h2 class="fw-bold text-dark mb-0"><?php echo e($penalties->count()); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-3">
            <div class="card border-0 bg-light shadow-sm rounded-4">
                <div class="card-body text-center py-4">
                    ...
                    <h2 class="fw-bold text-dark mb-0"><?php echo e($penalties->where('paid', false)->count()); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-3">
            <div class="card border-0 bg-light shadow-sm rounded-4">
                <div class="card-body text-center py-4">
                    ...
                    <h2 class="fw-bold text-dark mb-0"><?php echo e($penalties->where('paid', true)->count()); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-3">
            <div class="card border-0 bg-light shadow-sm rounded-4">
                <div class="card-body text-center py-4">
                    ...
                    <h2 class="fw-bold text-dark mb-0">₱<?php echo e(number_format($penalties->sum('amount'), 2)); ?></h2>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $penalties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $penalty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="border-top <?php echo e($penalty->is_overdue ? 'bg-danger bg-opacity-10' : ''); ?>">
                                    <td class="ps-4">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <?php endif; ?>
                                            <div>
                                                <h6 class="fw-semibold text-dark mb-0"><?php echo e($penalty->user->name ?? 'Unknown'); ?></h6>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="fw-bold text-dark">₱<?php echo e(number_format($penalty->amount, 2)); ?></span>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="d-inline-block text-truncate" style="max-width: 200px;" 
                                              data-bs-toggle="tooltip" data-bs-title="<?php echo e($penalty->reason); ?>">
                                    ...
                                    <td>
                                        <div class="text-dark">
                                            <?php echo e(\Carbon\Carbon::parse($penalty->applied_at)->format('M d, Y')); ?>
                    ...
                    <div class="col-md-6">
                        <div class="card border-0 bg-success bg-opacity-10 rounded-4">
                            <div class="card-body text-center py-4">
                                ...
                                <h2 class="fw-bold text-success mb-0">₱<?php echo e(number_format($penalties->where('paid', true)->sum('amount'), 2)); ?></h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card border-0 bg-warning bg-opacity-10 rounded-4">
                            <div class="card-body text-center py-4">
                                ...
                                <h2 class="fw-bold text-warning mb-0">₱<?php echo e(number_format($penalties->where('paid', false)->sum('amount'), 2)); ?></h2>
                            </div>
                        </div>
                    </div>
                </div>
                
                <?php if(isset($topPenalizedUsers) && $topPenalizedUsers->count() > 0): ?>
                            ...
                            <div class="list-group list-group-flush">
                                <?php $__currentLoopData = $topPenalizedUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="list-group-item bg-transparent d-flex justify-content-between align-items-center px-0">
                                        ...
                                        <span class="badge bg-danger rounded-pill px-3 py-2">
                                            <?php echo e($user->penalties_count); ?> penalties
                                        </span>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
