...
<div class="container my-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('donations.create')); ?>" class="btn btn-warning text-white fw-bold rounded-3 px-4">
    ...
    <?php if($donations->isEmpty()): ?>
        <div class="card border-0 shadow-sm rounded-4 bg-light">
            <div class="card-body text-center py-5">
                ...
                <a href="<?php echo e(route('donations.create')); ?>" class="btn btn-warning text-white rounded-3 px-4">
    ...
    <?php else: ?>
                                ...
                                <tr class="border-top">
                                    <td class="ps-4">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fw-semibold text-dark mb-0"><?php echo e($donation->user->name ?? 'N/A'); ?></h6>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fw-semibold text-dark mb-0"><?php echo e($donation->bereavementCase->title ?? 'N/A'); ?></h6>
                                                <small class="text-muted">
                                                    <?php echo e($donation->bereavementCase->user->name ?? 'Unknown Member'); ?>
                                    ...
                                    <td class="text-center">
                                        <?php if($donation->type === 'Money'): ?>
                                            <div class="d-flex align-items-center justify-content-center">
                                                ...
                                                <div>
                                                    <h6 class="fw-bold text-success mb-0">₱<?php echo e(number_format($donation->amount, 2)); ?></h6>
        ...
        <div class="d-flex justify-content-between align-items-center mt-4">
            <div class="text-muted">
                Showing <?php echo e($donations->count()); ?> donation(s)
            </div>
            <div class="text-muted">
                <i class="bi bi-info-circle me-1"></i>
                Total Records: <?php echo e($donations->count()); ?>
        ...
        tableRows.forEach(row => {
            row.addEventListener('click', function(e) {
                ...
                if (!e.target.closest('a') && !e.target.closest('button') && !e.target.closest('form')) {
                    ...
                    if (editLink && <?php echo e(auth()->user()->role === 'admin' ? 'true' : 'false'); ?>) {
