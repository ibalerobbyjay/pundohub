                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <strong class="text-dark">#<?php echo e($member->id); ?></strong>
                            </div>
                            <div class="col-md-4">
                                <small class="text-muted d-block">Registration Date</small>
                                <strong class="text-dark"><?php echo e($member->created_at->format('M d, Y')); ?></strong>
                            </div>
                            <div class="col-md-4">
                                <small class="text-muted d-block">Last Updated</small>
                                <strong class="text-dark"><?php echo e($member->updated_at->format('M d, Y')); ?></strong>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" 
                                   ...
                                   placeholder="Enter member's full name" value="<?php echo e(old('name', $member->name)); ?>" required>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="contact" id="contact" 
                                       ...
                                       value="<?php echo e(old('contact', str_replace('+63', '', $member->contact))); ?>">
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4" id="jobTypeDiv" style="display: <?php echo e(old('role', $member->role) == 'member' ? 'block' : 'none'); ?>;">
                            <label class="form-label fw-semibold text-dark">
                                <i class="bi bi-briefcase-fill text-warning me-2"></i>Member Job Type <span class="text-danger">*</span>
                            </label>
                            <select name="job_type" class="form-select border-0 rounded-3 bg-light" <?php echo e(old('role', $member->role) == 'member' ? 'required' : ''); ?>>
