                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                            ...
                            <div class="card bg-light border-0 rounded-3">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h6 class="fw-semibold text-dark mb-0">{{ Auth::user()->name }}</h6>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="type" id="type" class="form-select border-0 rounded-3 bg-light" {{ $userHasRecentCase ? 'disabled' : '' }} required>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="amount" id="amount" class="form-control border-0 rounded-3 bg-light" 
                                       step="0.01" min="100" {{ $userHasRecentCase ? 'disabled' : '' }} 
