...
<div class="container mt-5">
    ...
    <div class="text-center mb-5">
        ...
        <p class="text-light">Case #{{ $case->id }} - {{ $case->title }}</p>
    </div>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div>
                                ...
                                <p class="text-muted mb-0">{{ $case->user->name }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div>
                                ...
                                <p class="text-muted mb-0">{{ $case->date_of_death->format('F d, Y') }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div>
                                ...
                                <p class="text-muted mb-0">{{ $case->created_at->format('F d, Y g:i A') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div>
                                ...
                                <p class="text-muted mb-0">{{ $case->description_name ?? 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div>
                                ...
                                <p class="text-muted mb-0">{{ $case->description_what ?? 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div>
                                ...
                                <p class="text-muted mb-0">{{ $case->description_where ?? 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            @if($case->description_notes)
                <div class="mt-4 pt-4 border-top">
                    ...
                    <div class="card bg-light border-0 rounded-3">
                        <div class="card-body">
                            <p class="mb-0 text-dark">{{ $case->description_notes }}</p>
                        </div>
                    </div>
                </div>
            @endif
            ...
            @if($case->remarks)
                <div class="mb-4 p-4 bg-light border-0 rounded-3">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        ...
                        <span class="badge bg-info rounded-pill">Last updated: {{ $case->updated_at->diffForHumans() }}</span>
                    </div>
                    <p class="text-dark mb-0">{{ $case->remarks }}</p>
                </div>
            @else
            ...
            <form action="{{ route('bereavement-cases.updateRemarks', $case->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="remarks" id="remarks" 
                              ...
                              rows="4" 
                              placeholder="Add any remarks or updates about this case...">{{ old('remarks', $case->remarks) }}</textarea>
    ...
    <div class="d-flex gap-2">
        {{-- Show "All Cases" only if NOT a member --}}
        ...
        <a href="{{ route('dashboard') }}" class="btn btn-outline-info rounded-3 px-4">
            <i class="bi bi-arrow-left-circle me-2"></i> Dashboard
        </a>
    </div>

    <div class="d-flex gap-2">
        {{-- Show "Edit Case" only if NOT a member --}}
        @if(auth()->user()->role !== 'member')
            <a href="{{ route('bereavement-cases.edit', $case->id) }}" class="btn btn-outline-warning rounded-3 px-4">
